...
//This function is used for Sign up authentication to firebase with the help of email and password
      ...
      createUserWithEmailAndPassword(
        ...
        .then((userCredential) => {
          ...
          updateProfile(auth.currentUser, {
            ...
            photoURL:
              "https://static.vecteezy.com/system/resources/previews/042/149/073/non_2x/cute-cartoon-boy-man-face-expression-design-art-illustration-with-white-background-free-vector.jpg", email: formValues.email, contact: formValues.contact
          })
          console.log(user)
            .then(() => {
              // Profile updated!
...
//THIS CATCH FUNCTION Error is used to display the error if user already exists in the database.
  ...
  return (
    <div className="flex justify-center items-center h-screen">
      <div className=" border-black border-4 w-[400px] flex flex-col justify-center items-center  bg-cyan-500">
        {/* TITLE */}
